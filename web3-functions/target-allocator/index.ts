...
Web3Function.onRun(async (context: Web3FunctionContext) => {
  ...
  // console.log("checkerBytecode:", userArgs.checkerBytecode);
  ...
  const checkerBytecode = userArgs.checkerBytecode as string;
  if (!checkerBytecode) {
    throw new Error("userArgs.checkerBytecode not found");
  }
